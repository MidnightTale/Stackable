...
//    }
    ...
    private boolean isStackableItem(Material material) {
        return switch (material) {
            case POTION, MINECART, CHEST_MINECART, FURNACE_MINECART, TNT_MINECART, HOPPER_MINECART, OAK_BOAT,
                 ...
                 DARK_OAK_CHEST_BOAT, MANGROVE_CHEST_BOAT, CHERRY_CHEST_BOAT, TOTEM_OF_UNDYING, WHITE_SHULKER_BOX,
    ...
    private int getMaxStackSize(Material material) {
        return switch (material) {
            case POTION, MINECART, CHEST_MINECART, FURNACE_MINECART, TNT_MINECART, HOPPER_MINECART, OAK_BOAT,
                 SPRUCE_BOAT, BIRCH_BOAT, JUNGLE_BOAT, ACACIA_BOAT, DARK_OAK_BOAT, MANGROVE_BOAT, CHERRY_BOAT,
                 OAK_CHEST_BOAT, SPRUCE_CHEST_BOAT, BIRCH_CHEST_BOAT, JUNGLE_CHEST_BOAT, ACACIA_CHEST_BOAT,
                 DARK_OAK_CHEST_BOAT, MANGROVE_CHEST_BOAT, CHERRY_CHEST_BOAT, WHITE_SHULKER_BOX, ORANGE_SHULKER_BOX,
